...
import { useData, useExperience, useResults, useTranscript } from "../../state/store";
...
const VerOne = ({ setRef }) => {
  ...
  const { technical, experience, overall } = useResults();

  const [dashArray, setDashArray] = useState(overall);

  const { sql, tableau, r, python, bigData, spss } = useTranscript();

  const { dataCleaning, dataVisualization, modelling, programming } = useExperience();
  ...
  return (
    <div ref={(e) => setRef(e)} style={{ display: "flex", justifyContent: "center", paddingTop: "140px" }}>
      <div id="A4">
        <div className="page-1" style={{ height: " 841px", position: "relative", width: "595px" }}>
          <img className="logo" src={logo} alt="" />
          {userData.img ? <UserDataWithImage {...userData} /> : <UserData {...userData} />}

          <div className="test-result" style={{ left: 72, width: 427 }}>
          ...
          <div className="note">
            Note: It is recommended that the candidate’s data science skills as indicated in this Test report form be
            reassessed after two years from the written date above.
          </div>
          ...
          <div className="rating">
            <div className="rating-box" style={{ height: "44px" }}>
              ...
              <div className="rating-box-text">
                ...
                <p>
                  Able to cleansing of small-unstructured data and enabling analytical capability in order to query the
                  data and address various business needs. Interacts with and may influence immediate colleagues
                </p>
              </div>
            </div>
            ...
            <div className="rating-box" style={{ height: "74px" }}>
              ...
              <div className="rating-box-text">
                <h3>Intermediate</h3>
                <p>
                  Familiar with the wide range of mainstream commercial and open source data science tools, their
                  constraints, advantages and areas of application. Has fundamental awareness of data cleaning,
                  visualization, predictive analytics and machine learning algorithms. May contribute fully to the work
                  of teams.
                </p>
              </div>
            </div>
            ...
            <div className="rating-box">
              ...
              <div className="rating-box-text">
                <h3>Senior</h3>
                <p>
                  Has fully operational command of R or Python programming languages and several other commercial data
                  science tools. Has problem-solving approaches in order to blend data science expertise, business
                  intuition and programming capabilities with his/her work to apply these for data acquisition,
                  preprocessing, modelling, machine learning, model evaluation and deployment. Communicates effectively
                  at all levels to both technical and non-technical audiences.
                </p>
              </div>
            </div>
            ...
            <div className="rating-box">
              ...
              <div className="rating-box-text">
                <h3>Expert</h3>
                <p>
                  Has substantial data science knowledge and experience working on full-life cycle data science
                  practices and has outstanding optimized problem-solving approaches in order to blend data science
                  expertise, business intuition and programming capabilities. Demonstrates leadership and engages or
                  works with data specialists as necessary. Able to use R and Python programming languages and multiple
                  commercial tools and able to create data driven management solutions to separate business problems.
                </p>
              </div>
            </div>
          </div>
          ...
          <p className="footer-text">
            The validity of this CDS-ES test report form can be verified online by recognising organisation at:
            <a href="https://www.dsa.az/verification">www.dsa.az/verification</a>
          </p>
        </div>
            ...
            <div className="summary-main">
              ...
              <div className="svg-div"> 
                ...
                <svg className="svg-indicator">
                  <linearGradient id="gradient" x1="0%" y1="0%" x2={0} y2={`${overall}%`}>
                    <stop offset="0%" stopColor="rgba(0, 213, 255, 1)" />
                    <stop offset={`${dashArray + 100}%`} stopColor="rgba(0, 85, 255, 1)" />
                  </linearGradient>
                  ...
                  <circle
                    ...
                    style={{ strokeDashoffset: 300 - dashArray * 3 }}
                  />
                </svg>
              </div>
